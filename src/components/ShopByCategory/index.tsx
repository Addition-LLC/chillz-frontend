  ...
  const products = [
    {
      ...
      type: 'BLONDE STRAIGHT',
      img: '/images/shop1.jpg',
    },
    {
      id: 2,
      name: 'Curly Dark Style',
      type: 'BODY WAVE',
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-12 bg-[#FBF8F3]">
      ...
      <div className=" flex items-center justify-center text-center mt-10">
        ...
        >
          See All CATEGORY
          <span className="ml-3 flex items-center justify-center w-7 h-7 bg-white rounded-full">
            <ArrowUpRightIcon className="w-4 h-4 text-[#636340]" />
          </span>
        </button>
      </div>
    </section>
