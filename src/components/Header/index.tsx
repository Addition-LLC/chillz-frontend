...
import { menuData, Menu, MegaMenuCategory, MenuItem } from "./menuData";
          ...
          <div className="w-60 max-w-full px-4">
            <Link href="/" className="block py-5">
              <div className="flex flex-col -space-y-1">
                ...
                <span 
                  className="text-xs tracking-[0.2em] uppercase opacity-80"
            ...
            {menuData.map((menuItem: Menu) => (
              <div key={menuItem.id} className="group relative">
                ...
                {menuItem.submenu && (
                  ...
                  >
                    {menuItem.submenu.categories.map((cat: MegaMenuCategory) => (
