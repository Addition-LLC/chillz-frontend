...
const blogPosts = [
  {
    ...
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Sed euismod mauris.',
  },
  {
...
const BlogSection: React.FC = () => {
  return (
    <div className="flex flex-col items-center py-10 bg-[#FBF6ED]">
      <h2 className="text-4xl font-bold mb-8">LATEST FROM BLOG</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl px-4">
        {blogPosts.map((post) => (
          <div key={post.title} className="bg-[#FBF6ED] rounded-lg overflow-hidden">
