          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:px-16 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <span className="text-2xl font-bold text-[#F59E0B]">ChilzStyles</span>
                </Link>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-[#1F2937]">
                  CATEGORIES
                </h2>
                <ul>
                  <li>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <svg className="w-5 h-5 text-[#F59E0B] mt-1" fill="currentColor" viewBox="0 0 24 24">
